...
A tree-shaken `<VirtualScroll>` is 17.8 KB gzipped from `./core` and 24.2 KB from the package root; `core/style.css` is smaller than the full stylesheet. Both entries ship the same types.
