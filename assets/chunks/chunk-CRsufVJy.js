var e=[Object.freeze({displayName:`Mojo`,name:`mojo`,patterns:[{include:`#statement`},{include:`#expression`}],repository:{"annotated-parameter":{begin:`(?x)
\\b
([[:alpha:]_]\\w*) \\s* (:)
...
`,comment:`odd format or format-like syntax`,end:`(?=(['"])|((?<!\\\\)\\n))`,patterns:[{include:`#escape-sequence-unicode`},{include:`#string-entity`}]},"string-unicode-guts":{patterns:[{include:`#string-mojo-code-block`},{include:`#escape-sequence-unicode`},{include:`#string-entity`},{include:`#string-brace-formatting`}]}},scopeName:`source.mojo`})];export{e as default};