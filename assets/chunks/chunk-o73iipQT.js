...
(?=[+~>\\s,.\\#|){:\\[]|/\\*|$)`,name:`entity.name.tag.css`},"unicode-range":{captures:{0:{name:`constant.other.unicode-range.css`},1:{name:`punctuation.separator.dash.unicode-range.css`}},match:`(?<![\\w-])[Uu]\\+[0-9A-Fa-f?]{1,6}(?:(-)[0-9A-Fa-f]{1,6})?(?![\\w-])`},url:{begin:`(?i)(?<![\\w@-])(url)(\\()`,beginCaptures:{1:{name:`support.function.url.css`},2:{name:`punctuation.section.function.begin.bracket.round.css`}},end:`\\)`,endCaptures:{0:{name:`punctuation.section.function.end.bracket.round.css`}},name:`meta.function.url.css`,patterns:[{match:`[^'")\\s]+`,name:`variable.parameter.url.css`},{include:`#string`},{include:`#comment-block`},{include:`#escapes`}]}},scopeName:`source.css`})];export{e as t};