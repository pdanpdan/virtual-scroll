...
`,b={class:`flex flex-wrap gap-2 md:gap-4 items-start`},x={class:`flex flex-col items-stretch gap-4 p-5 bg-base-300 rounded-box border border-base-content/5 shadow-md`},S={class:`settings-item group`},C={class:`grid grid-cols-2 gap-2 mt-2`},w={class:`example-vertical-item example-vertical-item--fixed`},T={class:`example-badge mr-4`},E={class:`font-medium`},D=s({__name:`+Page`,setup(e){let s=i(Array.from({length:50},(e,t)=>({id:`orig-${t}`,label:`Original Item ${t}`}))),d=i(0),f=i(!0),D=i(null),O=r(`debugMode`,i(!1));function k(){s.value=[...Array.from({length:5},(e,t)=>({id:`prepended-${d.value+t}`,label:`Prepended Item ${d.value+t}`})),...s.value],d.value+=5}let A=i(0);function j(){let e=Array.from({length:5},(e,t)=>({id:`appended-${A.value+t}`,label:`Appended Item ${A.value+t}`}));s.value=[...s.value,...e],A.value+=5}function M(e){D.value=e}return(e,r)=>(o(),p(_,{code:c(y)},{title:h(()=>[...r[2]||=[l(`span`,{class:`example-title example-title--group-3`},`Scroll Restoration`,-1)]]),description:h(()=>[r[3]||=n(` Demonstrates the `,-1),r[4]||=l(`strong`,null,`restoreScrollOnPrepend`,-1),n(` prop. Currently showing `+a(s.value.length.toLocaleString())+` items. When items are added to the beginning of the list, the scroll position is adjusted to keep the current view stable. `,1)]),icon:h(()=>[...r[5]||=[l(`svg`,{xmlns:`http://www.w3.org/2000/svg`,fill:`none`,viewBox:`0 0 24 24`,"stroke-width":`1.5`,stroke:`currentColor`,class:`example-icon example-icon--group-3`},[l(`path`,{"stroke-linecap":`round`,"stroke-linejoin":`round`,d:`M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99`,class:`rotate-180 origin-center`})],-1)]]),subtitle:h(()=>[...r[6]||=[n(` Maintain scroll position when prepending items `,-1)]]),controls:h(()=>[l(`div`,b,[m(v,{"scroll-details":D.value,direction:`vertical`},null,8,[`scroll-details`]),l(`div`,x,[l(`label`,S,[r[7]||=l(`span`,{class:`settings-label`},`Restore on Prepend`,-1),t(l(`input`,{"onUpdate:modelValue":r[0]||=e=>f.value=e,type:`checkbox`,class:`toggle toggle-primary toggle-sm`},null,512),[[u,f.value]])]),l(`div`,C,[l(`button`,{class:`btn btn-sm btn-primary`,onClick:k},`Prepend 5`),l(`button`,{class:`btn btn-sm btn-primary`,onClick:j},`Append 5`),l(`button`,{class:`btn btn-sm btn-error btn-soft col-span-2`,onClick:r[1]||=e=>s.value=[]},`Clear Items`)])])])]),default:h(()=>[m(c(g),{debug:c(O),class:`example-container`,items:s.value,"item-size":60,"restore-scroll-on-prepend":f.value,onScroll:M},{item:h(({item:e,index:t})=>[l(`div`,w,[l(`span`,T,`#`+a(t),1),l(`span`,E,a(e.label),1)])]),_:1},8,[`debug`,`items`,`restore-scroll-on-prepend`])]),_:1},8,[`code`]))}}),O=e({default:()=>k},1),k=D;const A={hasServerOnlyHook:{type:`computed`,definedAtData:null,valueSerialized:{type:`js-serialized`,value:!1}},isClientRuntimeLoaded:{type:`computed`,definedAtData:null,valueSerialized:{type:`js-serialized`,value:!0}},onBeforeRenderEnv:{type:`computed`,definedAtData:null,valueSerialized:{type:`js-serialized`,value:null}},dataEnv:{type:`computed`,definedAtData:null,valueSerialized:{type:`js-serialized`,value:null}},guardEnv:{type:`computed`,definedAtData:null,valueSerialized:{type:`js-serialized`,value:null}},onRenderClient:{type:`standard`,definedAtData:{filePathToShowToUser:`vike-vue/__internal/integration/onRenderClient`,fileExportPathToShowToUser:[]},valueSerialized:{type:`pointer-import`,value:d}},Page:{type:`standard`,definedAtData:{filePathToShowToUser:`/pages/feature-scroll-restoration/+Page.vue`,fileExportPathToShowToUser:[]},valueSerialized:{type:`plus-file`,exportValues:O}},hydrationCanBeAborted:{type:`standard`,definedAtData:{filePathToShowToUser:`vike-vue/config`,fileExportPathToShowToUser:[`default`,`hydrationCanBeAborted`]},valueSerialized:{type:`js-serialized`,value:!0}},Layout:{type:`cumulative`,definedAtData:[{filePathToShowToUser:`/pages/+Layout.vue`,fileExportPathToShowToUser:[]}],valueSerialized:[{type:`plus-file`,exportValues:f}]},title:{type:`standard`,definedAtData:{filePathToShowToUser:`/pages/feature-scroll-restoration/+config.ts`,fileExportPathToShowToUser:[`default`,`title`]},valueSerialized:{type:`js-serialized`,value:`Scroll Restoration - Virtual Scroll`}}};export{A as configValuesSerialized};